/* global React, Ico, AgentApi, marked, DOMPurify, useDialog */
...
function SessionsModal({ open, convId, currentSessionNumber = null, currentMessages = null, onClose }){
...
window.SessionsModal = SessionsModal;

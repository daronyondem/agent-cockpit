...
| Codex thread goals | `src/services/backends/codex.ts`, `src/routes/chat.ts`, `src/routes/chat/goalRoutes.ts`, `src/types/index.ts`, `src/contracts/responses.ts`, `web/AgentCockpitWeb/src/shell.jsx`, `web/AgentCockpitWeb/src/streamStore.js`, `mobile/AgentCockpitPWA/src/App.tsx`, `mobile/AgentCockpitPWA/src/api.ts`, `mobile/AgentCockpitPWA/src/appModel.ts`, `mobile/AgentCockpitPWA/src/types.ts`, `mobile/AgentCockpitPWA/src/styles.css` | `docs/spec-api-endpoints.md`, `docs/spec-backend-services.md`, `docs/spec-frontend.md`, `docs/spec-mobile-pwa.md`, `BACKENDS.md`, `docs/adr/0032-use-codex-thread-goals-for-goal-mode.md` | `test/codexBackend.test.ts`, `test/chat.rest.test.ts`, `test/frontendRoutes.test.ts`, `test/goalState.test.ts`, `test/mobileAppModel.test.ts` | Adapter dispatch and chat lifecycle below. |

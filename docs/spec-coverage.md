...
| Streaming, WebSocket replay, abort, durable stream jobs, finalizers | `src/contracts/streamFrames.ts`, `src/ws.ts`, `src/services/streamJobRegistry.ts`, `src/services/streamJobSupervisor.ts`, `src/services/sessionFinalizerQueue.ts`, `src/routes/chat.ts`, `src/routes/chat/streamRoutes.ts`, `src/routes/chat/goalRoutes.ts`, `web/AgentCockpitWeb/src/stream/streamFrameReducer.ts`, `web/AgentCockpitWeb/src/streamStore.js` | `docs/spec-api-endpoints.md`, `docs/spec-backend-services.md`, `docs/spec-data-models.md`, `docs/spec-frontend.md`, `docs/adr/0077-keep-browser-stream-frames-in-a-shared-contract-and-reducer.md` | `test/processStream.golden.test.ts`, `test/chat.websocket.test.ts`, `test/chat.streaming.test.ts`, `test/chat.rest.test.ts`, `test/sessionFinalizerQueue.test.ts`, `test/streamFrameReducer.test.ts`, `test/streamStore.test.ts` | Chat lifecycle below. |
| Backend adapters and CLI profiles | `src/services/backends/base.ts`, `src/services/backends/registry.ts`, `src/services/backends/toolUtils.ts`, `src/services/backends/mediaCapabilities.ts`, `src/services/backends/claudeCode.ts`, `src/services/backends/kiro.ts`, `src/services/backends/codex.ts`, `src/services/backends/opencode.ts`, `src/services/cliProfiles.ts`, `src/services/cliProfileAuthService.ts` | `docs/spec-backend-services.md`, `docs/spec-api-endpoints.md`, `docs/spec-data-models.md`, `BACKENDS.md`, `docs/archive/cli-profiles-multi-account-plan.md`, `docs/adr/0076-add-opencode-cli-profiles.md`, `docs/adr/0085-represent-claude-code-ultracode-as-a-provider-session-mode.md` | `test/backends.test.ts`, `test/toolUtils.test.ts`, `test/mediaCapabilities.test.ts`, `test/kiroBackend.test.ts`, `test/codexBackend.test.ts`, `test/opencodeBackend.test.ts`, `test/chat.cliProfileAuth.test.ts` | Adapter dispatch flow below. |

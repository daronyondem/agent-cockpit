...
| Workspace worktree isolation | `src/services/chat/worktreeIsolationService.ts`, `src/services/chatService.ts`, `src/routes/chat/worktreeIsolationRoutes.ts`, `src/routes/chat/streamRoutes.ts`, `src/routes/chat/goalRoutes.ts`, `src/routes/chat/uploadRoutes.ts`, `src/routes/chat/gitRoutes.ts`, `src/contracts/worktreeIsolation.ts`, `src/contracts/responses.ts`, `src/types/index.ts`, `web/AgentCockpitWeb/src/api.js`, `web/AgentCockpitWeb/src/workspaceSettings.jsx`, `web/AgentCockpitWeb/src/chat/chatLive.jsx`, `web/AgentCockpitWeb/src/chat/messageContent.jsx`, `mobile/AgentCockpitPWA/src/api.ts`, `mobile/AgentCockpitPWA/src/appModel.ts` | `docs/spec-data-models.md`, `docs/spec-api-endpoints.md`, `docs/spec-backend-services.md`, `docs/spec-frontend.md`, `docs/spec-mobile-pwa.md`, `docs/spec-server-security.md`, `docs/adr/0072-use-per-conversation-git-worktrees-for-workspace-isolation.md`, `docs/adr/0073-use-stable-workspace-identities.md` | `test/chat.worktreeIsolation.test.ts`, `test/chat.git.test.ts`, `test/frontendRoutes.test.ts`, `test/mobileAppModel.test.ts`, `test/fileLinks.test.ts` | Chat lifecycle and frontend/client flow below. |
| Workspace memory capture, MCP, search, consolidation, and Workspace Context consumption | `src/services/memoryWatcher.ts`, `src/services/memoryMcp/index.ts`, `src/services/memoryMcp/stub.cjs`, `src/services/chatService.ts`, `src/routes/chat.ts`, `src/routes/chat/memoryRoutes.ts`, `src/services/workspaceContext/service.ts` | `docs/spec-backend-services.md`, `docs/spec-data-models.md`, `docs/spec-api-endpoints.md`, `docs/spec-frontend.md`, `docs/adr/0081-make-workspace-context-consume-memory-inbox.md` | `test/memoryWatcher.test.ts`, `test/memoryMcp.test.ts`, `test/chat.memory.test.ts`, `test/chatService.workspaceMemory.test.ts`, `test/workspaceContext.service.test.ts`, `test/frontendRoutes.test.ts` | Memory flow below. |

...
| Backend goal mode | `src/services/backends/codex.ts`, `src/services/backends/codexRuntime.ts`, `src/services/backends/codexProtocol.ts`, `src/services/backends/codexEvents.ts`, `src/services/backends/codexStreamDispatch.ts`, `src/services/backends/codexModels.ts`, `src/services/backends/codexProcess.ts`, `src/services/backends/claudeCode.ts`, `src/services/chat/goalEventMessages.ts`, `src/routes/chat.ts`, `src/routes/chat/goalRoutes.ts`, `src/types/index.ts`, `src/contracts/responses.ts`, `web/AgentCockpitWeb/src/chat/composer.jsx`, `web/AgentCockpitWeb/src/chat/messageFeed.jsx`, `web/AgentCockpitWeb/src/streamStore.js`, `web/AgentCockpitWeb/src/goalState.js`, `mobile/AgentCockpitPWA/src/App.tsx`, `mobile/AgentCockpitPWA/src/mobileChatScreen.tsx`, `mobile/AgentCockpitPWA/src/api.ts`, `mobile/AgentCockpitPWA/src/appModel.ts`, `mobile/AgentCockpitPWA/src/types.ts`, `mobile/AgentCockpitPWA/src/styles.css` | `docs/spec-api-endpoints.md`, `docs/spec-backend-services.md`, `docs/spec-data-models.md`, `docs/spec-frontend.md`, `docs/spec-mobile-pwa.md`, `BACKENDS.md`, `docs/adr/0032-use-codex-thread-goals-for-goal-mode.md`, `docs/adr/0057-represent-goal-mode-as-backend-capability-driven.md`, `docs/adr/0089-keep-codex-stream-dispatch-in-a-focused-module.md` | `test/codexBackend.test.ts`, `test/backends.test.ts`, `test/chat.rest.test.ts`, `test/frontendRoutes.test.ts`, `test/streamStore.test.ts`, `test/goalState.test.ts`, `test/mobileAppModel.test.ts` | Adapter dispatch and chat lifecycle below. |
| Attachments, generated artifacts, OCR, file delivery | `src/contracts/uploads.ts`, `src/routes/chat.ts`, `src/routes/chat/uploadRoutes.ts`, `src/services/chat/dngPreview.ts`, `src/services/chat/uploadImageNormalization.ts`, `src/services/backends/*`, `web/AgentCockpitWeb/src/fileLinks.ts`, `web/AgentCockpitWeb/src/streamStore.js`, `web/AgentCockpitWeb/src/chat/chatLive.jsx`, `web/AgentCockpitWeb/src/chat/composer.jsx`, `web/AgentCockpitWeb/src/chat/attachments.jsx`, `web/AgentCockpitWeb/src/chat/fileViewerPanel.jsx`, `web/AgentCockpitWeb/src/chat/messageContent.jsx`, `web/AgentCockpitWeb/src/chat/messageFeed.jsx`, `mobile/AgentCockpitPWA/src/api.ts`, `mobile/AgentCockpitPWA/src/App.tsx`, `mobile/AgentCockpitPWA/src/mobileChatScreen.tsx`, `mobile/AgentCockpitPWA/src/mobileFileModals.tsx` | `docs/spec-api-endpoints.md`, `docs/spec-data-models.md`, `docs/spec-frontend.md`, `docs/spec-mobile-pwa.md`, `docs/adr/0083-extract-dng-embedded-previews-for-chat-uploads.md` | `test/dngPreview.test.ts`, `test/fileLinks.test.ts`, `test/chat.rest.test.ts`, `test/chat.streaming.test.ts`, `test/streamStore.test.ts`, `test/frontendRoutes.test.ts` | Frontend/client flow below. |
...
| Workspace file explorer and Git changes | `src/routes/chat.ts`, `src/routes/chat/filesystemRoutes.ts`, `src/routes/chat/explorerRoutes.ts`, `src/routes/chat/gitRoutes.ts`, `src/contracts/explorer.ts`, `src/contracts/gitChanges.ts`, `web/AgentCockpitWeb/src/api.js`, `web/AgentCockpitWeb/src/screens/filesBrowser.jsx`, `mobile/AgentCockpitPWA/src/App.tsx`, `mobile/AgentCockpitPWA/src/mobileFileModals.tsx`, `mobile/AgentCockpitPWA/src/api.ts` | `docs/spec-api-endpoints.md`, `docs/spec-frontend.md`, `docs/spec-mobile-pwa.md`, `docs/spec-server-security.md`, `docs/parity-decisions.md` | `test/chat.explorer.test.ts`, `test/chat.git.test.ts`, `test/chat.rest.test.ts`, `test/frontendRoutes.test.ts` | Frontend/client flow below. |

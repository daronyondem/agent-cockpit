...
| Data-root export/import migration | `src/contracts/dataMigration.ts`, `src/services/dataMigrationService.ts`, `src/routes/chat/dataMigrationRoutes.ts`, `src/routes/chat.ts`, `server.ts`, `web/AgentCockpitWeb/src/api.js`, `web/AgentCockpitWeb/src/screens/settingsScreen.jsx` | `docs/spec-api-endpoints.md`, `docs/spec-data-models.md`, `docs/spec-backend-services.md`, `docs/spec-server-security.md`, `docs/spec-frontend.md`, `docs/spec-mobile-pwa.md`, `docs/reference/data-layout.md`, `docs/adr/0074-use-data-root-bundles-for-migration.md` | `test/dataMigrationService.test.ts`, `test/chat.dataMigration.test.ts`, `test/frontendRoutes.test.ts` | Startup sequence in `docs/spec-server-security.md`; frontend/client flow below. |

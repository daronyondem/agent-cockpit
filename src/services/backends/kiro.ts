    ...
    return {
      ...
      models: [
        ...
        },
        {
          ...
          family: 'sonnet',
          description: 'Experimental preview of Claude Sonnet 5 with a 1M context window',
          costTier: 'medium',
          capabilities: TEXT_IMAGE_MODEL_CAPABILITIES,
        },
        {
          ...
          family: 'opus',
          description: 'Strongest Opus model for self-verification, efficient tool calling, and long-running agentic tasks',
          costTier: 'high',
          capabilities: TEXT_IMAGE_MODEL_CAPABILITIES,
        },
        {
          ...
          label: 'gpt-5.6-sol',
          family: 'gpt',
          description: 'Experimental preview of OpenAI GPT-5.6 Sol with a 272K context window',
          costTier: 'high',
        ...
        },
        {
          ...
          label: 'gpt-5.6-terra',
          family: 'gpt',
          description: 'Experimental preview of OpenAI GPT-5.6 Terra with a 272K context window',
          costTier: 'medium',
          capabilities: TEXT_ONLY_MODEL_CAPABILITIES,
        },
        {
          ...
          label: 'gpt-5.6-luna',
          family: 'gpt',
          description: 'Experimental preview of OpenAI GPT-5.6 Luna with a 272K context window',
          costTier: 'low',
          capabilities: TEXT_ONLY_MODEL_CAPABILITIES,
        },
        {
          ...
          family: 'opus',
          description: 'Adaptive-thinking Opus model with enhanced agentic capabilities and 3x higher resolution vision',
          costTier: 'high',
          capabilities: TEXT_IMAGE_MODEL_CAPABILITIES,
        },
        {
        ...
        },
        {
          ...
          family: 'fable',
          description: 'Internal development preview; not for customer data, ITAR, or PII',
          costTier: 'high',
          capabilities: TEXT_IMAGE_MODEL_CAPABILITIES,
        },
        {

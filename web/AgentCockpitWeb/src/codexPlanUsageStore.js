...
const subsByKey = new Map();
  ...
  function refresh(cliProfileId){
    ...
    if (!AgentApi || !AgentApi.getCodexPlanUsage) {
      return Promise.resolve(null);
    }
    const inFlight = AgentApi.getCodexPlanUsage(cliProfileId || null)
...
export const CodexPlanUsageStore = { get, refresh, subscribe };

export default CodexPlanUsageStore;

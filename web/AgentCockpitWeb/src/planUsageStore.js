...
const subsByKey = new Map();
  ...
  function refresh(cliProfileId){
    ...
    if (!AgentApi || !AgentApi.getClaudePlanUsage) {
      return Promise.resolve(null);
    }
    const inFlight = AgentApi.getClaudePlanUsage(cliProfileId || null)
...
export const PlanUsageStore = { get, refresh, subscribe };

export default PlanUsageStore;
